...
# play on a 3x3 board both random agents
AGENT = -1
COMP = +1
...
def winState(state, player):
    ...
    if [player, player, player] in win_state_small_board:
        return True
    else:
        return False
...
if __name__ == '__main__':
    print("Tic Tac Toe Game Using Random Agent 3x3 board")
    main()
